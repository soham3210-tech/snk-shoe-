...
// newly added routers
router.post("/updateProfileImage", authMiddelware, updateProfileImage); //updating Profile Image
router.post("/resetPassword", authMiddelware, resetPassword); //updating password
